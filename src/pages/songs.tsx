          ...
          <div className="mb-10">
            ...
            <div className="relative mt-8 max-w-md">
              <input
                ...
                className="w-full rounded-2xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-white placeholder:text-zinc-500 outline-none backdrop-blur transition focus:border-fuchsia-400"
              />
            </div>
          </div>
